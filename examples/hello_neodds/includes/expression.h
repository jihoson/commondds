...
extern "C" {
#endif
	DDS_DLL_API	expression_t *expression_newFunction(function_type f_type, expression_list_t *p_list);
	DDS_DLL_API	expression_list_t *expression_insert(expression_list_t *list, expression_t *p_expr);
	DDS_DLL_API	expression_t *expression_newIdendifier(char *string_mds);
	DDS_DLL_API	expression_t *expression_newString(char *string_mds);
	DDS_DLL_API	expression_t *expression_newInteger(long value);
	DDS_DLL_API	expression_t *expression_newDouble(double value);
	DDS_DLL_API	expression_t *expression_newCharacter(char value);
	DDS_DLL_API	expression_list_t *expression_append(expression_list_t *list, expression_t *p_expr);
	DDS_DLL_API	void expression_print(expression_t *p_expr, long tab);
	DDS_DLL_API	expression_t expression_caculate(expression_t *p_expr, FooTypeSupport *p_typeSupport, char *p_value, int i_size);
	DDS_DLL_API	expression_t expression_caculate_for_message(expression_t *p_expr, FooTypeSupport *p_typeSupport, char *p_value, int i_size, StringSeq query_parameters);
#ifdef __cplusplus
}
#endif
